...
async function showFavourites() {
    ...
    let res = await fetch(`https://storage.conchbrain.club/${userInfo.id}/get?ConchFavourites`);
        ...
        let html = `
            <div id="${id}" class="col-md-6 animate__animated animate__bounceIn">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            <a href="${favourite.link}" target="_blank">${favourite.link.replace("https://github.com/", "")}</a>
